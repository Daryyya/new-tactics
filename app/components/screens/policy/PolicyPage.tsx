    ...
    <section className={styles.policy}>
      <div className="container">
        ...
        <p>
          ...
          которую сайт Корпоративные системы, (далее – Сайт) расположенный на
          доменном имени protactics.ru (а также его субдоменах), может получить
          о Пользователе во время использования сайта protactics.ru (а также его
        ...
        <p>
          ...
          сотрудники на управление сайтом Корпоративные системы, действующие от
          имени ИП Салтанюк, которые организуют и (или) осуществляют обработку
        ...
        <p>
          1.1.5. «Сайт Корпоративные системы» - это совокупность связанных между
          собой веб-страниц, размещенных в сети Интернет по уникальному адресу
          (URL): protactics.ru, а также его субдоменах.
        </p>
        <p>
          1.1.6. «Субдомены» - это страницы или совокупность страниц,
          расположенные на доменах третьего уровня, принадлежащие сайту
          Корпоративные системы, а также другие временные страницы, внизу
          который указана контактная информация Администрации
        </p>
        <p>
          1.1.5. «Пользователь сайта Корпоративные системы » (далее
          Пользователь) – лицо, имеющее доступ к сайту Корпоративные системы,
          посредством сети Интернет и использующее информацию, материалы и
          продукты сайта Корпоративные системы.
        </p>
        <p>
        ...
        <p>
          2.1. Использование сайта Корпоративные системы Пользователем означает
        ...
        <p>
          ...
          Пользователь должен прекратить использование сайта Корпоративные
          системы .
        </p>
        <p>
          2.3. Настоящая Политика конфиденциальности применяется к сайту
          Корпоративные системы. Сайт не контролирует и не несет ответственность
          за сайты третьих лиц, на которые Пользователь может перейти по
          ссылкам, доступным на сайте Корпоративные системы.
        </p>
        <p>
        ...
        <p>
          ...
          Корпоративные системы, при подписке на информационную e-mail рассылку
        ...
        <p>
          ...
          заполнения форм на сайте Корпоративные системы и включают в себя
        ...
        <p>
          ...
          посещении страниц: <br /> - IP адрес; <br /> - информация из cookies;
          <br /> - информация о браузере- время доступа; <br /> - реферер (адрес
          предыдущей страницы).
        </p>
        <p>
        ...
        <p>
          ...
          Корпоративные системы, если Пользователь дал согласие на создание
          учетной записи.
        </p>
        ...
        <p>
          ...
          имени сайта Корпоративные системы.
        </p>
        <p>
        ...
        <p>
          ...
          Пользователя, оформленного на сайте Корпоративные системы, включая
        ...
        <p>
          ...
          данных, необходимых для использования сайта Корпоративные системы, и
        ...
        <p>
          ...
          которой он может иметь доступ как к части сайта Корпоративные системы,
          несет лицо, предоставившее такую информацию.
        </p>
        <p>
          7.5. Пользователь соглашается, что информация, предоставленная ему как
          часть сайта Корпоративные системы, может являться объектом
          интеллектуальной собственности, права на который защищены и
          принадлежат другим Пользователям, партнерам или рекламодателям,
          которые размещают такую информацию на сайте Корпоративные
          системы.Пользователь не вправе вносить изменения, передавать в аренду,
        ...
        <p>
          ...
          в свободном публичном доступе на сайте Корпоративные системы)
        ...
        <p>
          ...
          иных коммуникационных данных, содержащихся на сайте Корпоративные
          системы или передаваемых через него.
        </p>
        <p>
        ...
        <p>
          ...
          размещенную пользователем на сайте Корпоративные системы, включая, но
          не ограничиваясь: информацию, защищенную авторским правом, без прямого
          согласия владельца авторского права.
        </p>
        <h2>8. Дополнительные условия</h2>
        <p>
          8.1. Администрация вправе вносить изменения в настоящую Политику
          конфиденциальности без согласия Пользователя.
        </p>
        <p>
          8.2. Новая Политика конфиденциальности вступает в силу с момента ее
          размещения на сайте Корпоративные системы, если иное не предусмотрено
          новой редакцией Политики конфиденциальности.
        </p>
        <p>
          8.3. Все предложения или вопросы касательно настоящей Политики
          конфиденциальности следует сообщать по адресу: connect@protactics.ru
        </p>
        <p>
          8.4. Действующая Политика конфиденциальности размещена на странице по
          адресу http://protactics.ru/politika.html
        </p>
        <p>Обновлено: 14 Марта 2023 года</p>
        <p>г. Оренбург, ИП Салтанюк</p>
      </div>
    </section>
  );
};
