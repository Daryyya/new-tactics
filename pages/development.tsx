...
const Development: NextPage = () => {
  return (
    ...
    >
      <ServiceTemplate
        title="Разработка"
        description="Тестирование гипотез и запуск MVP:
