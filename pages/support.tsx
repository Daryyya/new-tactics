  ...
  return (
    ...
    >
      <ServiceTemplate
        ...
        programProducts={[
          "Поддерживаем технически проект после разработки и запуска",
          "Обновляем и расширяем любую систему по запросу нашего клиента",
          "Следим за постоянной работоспособностью системы",
          "Помогаем вашим клиентам свободно использовать полный спектр функций готовой системы",
          "Поможем провести повышение квалификации ваших сотрудников в компании, в связи с внедрением новых инструментов в бизнес",
        ]}
      />
    </Layout>
  );
