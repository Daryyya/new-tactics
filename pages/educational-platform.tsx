...
import EducationalPlatformBanner from "@/components/screens/EducationalPlatform/EducationalPlatformBanner";
...
const EducationalPlatform = () => {
  ...
  return (
    <Layout title="Разработка образовательных платформ" description="description">
